...
#### [Slack workspace](https://ip-sp-23-ladyk.slack.com) The URL is: https://ip-sp-23-ladyk.slack.com. You must first have an account with Slack. Once you've signed up with Slack, you may join our workspace using the following link (only good for 30 days): 

[**Link to join Slack**](https://join.slack.com/t/slack-mv38828/shared_invite/zt-1nw19mwg1-TnrQXHUiUGCVYOhavZOTgQ)
